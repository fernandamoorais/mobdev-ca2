...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuotesPage = /*#__PURE__*/function () {
      function QuotesPage(api, router) {
      ...
      _createClass(QuotesPage, [{
        ...
        value: function ngOnInit() {
          this.LoadQuotes(); //this.quotes = this.api.getQuotes();
        ...
        key: "searchBarQuote",
        value: function searchBarQuote(event) {
          var _this2 = this;
          ...
          this.api.searchQuote(this.author).subscribe(function (data) {
            _this2.quotes = data;
          }, function (res) {
            //
            _this2.quotes = [];
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], QuotesPage);
    /***/
  }
}]);
