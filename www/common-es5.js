...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); //this ONE 
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getCharacters(offset) {
          return this.http.get("https://www.breakingbadapi.com/api/characters?limit=15&offset=".concat(offset));
        }
      }, {
        key: "getCharacter",
        ...
        value: function getQuote(id) {
          return this.http.get("https://breakingbadapi.com/api/quotes/".concat(id)); //using Id as paramether to get ecah quote of the charecters 
        }
      }, {
        key: "getDeaths",
        ...
        key: "searchDeath",
        value: function searchDeath(search) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(encodeURI(search)));
        }
      }]);
  ...
  function srcAppServicesLikeServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY = 'likeCharacters';
    var STORAGE_KEY2 = 'likeEpisodes;';
    ...
    var LikeService = /*#__PURE__*/function () {
      ...
      _createClass(LikeService, [{
        ...
        key: "isFav",
        value: function isFav(episodeId) {
        ...
        key: "favouriteEp",
        value: function favouriteEp(episodeId) {
          var _this = this;

          return this.getAllFavouriteEps().then(function (result) {
            if (result) {
              result.push(episodeId);
              return _this.storage.set(STORAGE_KEY2, result);
            } else {
              return _this.storage.set(STORAGE_KEY2, [episodeId]);
            }
          });
        }
      }, {
        key: "unfavouriteEp",
        value: function unfavouriteEp(episodeId) {
          var _this2 = this;
          ...
          return this.getAllFavouriteEps().then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(STORAGE_KEY2, result);
            }
          });
        }
      }]);
