...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["character-details-character-details-module"], {
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharacterDetailsPage = /*#__PURE__*/function () {
      ...
      function CharacterDetailsPage(activatedRoute, api, likeServices) {
      ...
      _createClass(CharacterDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.likeServices.isFav(this.charId).then(function (isFav) {
        ...
        value: function favouriteEp() {
          ...
          this.likeServices.favouriteEp(this.charId).then(function () {
        ...
        value: function unfavouriteEp() {
          ...
          this.likeServices.unfavouriteEp(this.charId).then(function () {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], src_app_services_like_service__WEBPACK_IMPORTED_MODULE_4__["LikeService"]])], CharacterDetailsPage);
    /***/
  }
}]);
